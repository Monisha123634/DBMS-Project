...
<body> 
	...
	<table align="center" border="0" bgcolor="white" width="400"  height="525">
          <tr>
               
            <td   border="1" align ="center" colspan='3' height='1'><img src="e.png"></td>
	...
	<form id="frmReg" method="POST" action="validateofficer.php">
       <h2 id="hdr_title">Officer Registration Form  </h2>
             <div class="control_input">
                <label for="id" class="label">Officer id</label><input type="text" id="id" name="id" class="reg_fields" required placeholder="978077"/>
            </div>
            <div class="control_input">
            ...
            <div class="control_input">               
                ...
                <table><tr>
                    ...
                    <td>
                        <input type="text" id="txtDay" name="txtDay" style="width: 40px;"  class="reg_fields" required placeholder="DD"/>
                        <input type="text" id="txtYear" name="txtYear" style="width: 60px;"  class="reg_fields" required placeholder="YYYY"/>
                    </td>
                    </tr></table>
                </div>
            </div>
