...
$query ="SELECT * FROM prisonerdetails WHERE id LIKE '%$searchTerm%'";
...
{
	echo'<body><table  align="center" width="400" height="400"><tr> 
            <td  align ="center" ><img src="se_1.jpg"></td>
            </tr></body>';
